...
//			}
			...
			//check space or bed available to generate the bed

               if((int)$request->available_space == 1){

                   $bed_arr = [
                       'first' => '0',
                   ];
               }
                 else if((int)$request->available_space == 2){
                 ...
                 else if((int)$request->available_space == 3){
                 ...
                 else if((int)$request->available_space == 4){
                 ...
                 else if((int)$request->available_space == 5){
                 ...
                 else if((int)$request->available_space == 6){
			 ...
			 //check if the room already added to the hostel
			$room_exist = Room::where(['campus_id' => $request->campus_id, 'hostel_id' =>$request->hostel_id, 'room_no' =>$request->room_no])->first();

			 if($room_exist){

                 return redirect()->route('hostels.show', $request->hostel_id)->with('error', 'Room number already be taken');
			...
			$room->available = $request->available_space;
