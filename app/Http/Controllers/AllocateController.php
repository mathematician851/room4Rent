...
class AllocateController extends Controller
{
	...
	public function index(){
		...
		if(isset($_GET['h']) && $_GET['h'] != ""){
            ...
            $data = Hostel::where('id', $hosId)->orderBy('id', 'desc')->with('images', 'campus')->first();
            return view('student.allocate')->with('data', $data)->withStudent($std)->withAvailables($availables);
	...
	public function getBed(Request $request){
		...
		return response()->json(['space'=>$space, 'amount'=> $bed->amount]);
	}
