	...
	<div class="col-md-6 bg-white msg-card pb-3">
		<div class="row head-color">
			<div class="col-2 mt-3 mb-2">
				<img src="{{asset('image/uew.jpg')}}" alt="logo" class="img-logo">
			</div>
			<div class="col-9 line mb-2">
				<h3 class="text-center h3 text-shadow mt-3">ROOM  RENT SYSTEM</h3>
			</div>
		</div>
		<div>
			<h6 class="font-weight-bold text-danger">Welcome to Room rental portal. For new applicatants take the steps listed below.</h6>
			<ul>
