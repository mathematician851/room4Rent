			...
			<tbody>
				...
				<tr class="<?= ($room->available == 0)? 'bg-danger-lighten': '' ?>">
					...
					<td>
						...
						<td>
							<span class="mx-3">{{$room->amount}}</span>
						</td>
	...
	<div class="col-md-5">
		<div class="card mt-4">
			...
			<div class="card-body">
                ...
                <div class=" form-group row">
                    {{Form::label('available_space', 'Bed Space Available:', ['class' => 'col-4 col-form-label text-md-left'])}}
                    <div class="col">
                        <select name="available_space" id="available_space" class="form-control">
							<option value="">Select Bed Available</option>
				...
				<div class=" form-group row" id="hideMe" style="display: none">
					{{Form::label('amount', 'Amount of each:', ['class' => 'col-4 col-form-label text-md-left'])}}
...
<script>
	...
	$(function(){
		...
		$("#available_space").change(function(){
			 ...
			 if($(this).val() !=""){
				 $("#hideMe").show();
				 $("#amount").html("<input type='number' name='amount' class='form-control'>");
