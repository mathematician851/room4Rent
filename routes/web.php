...
Route::get('/hostel/details/{id}', 'FrontendController@show')->name('hostel.details');
Route::get('/user/login', 'FrontendController@login')->middleware('guest')->name('user.login');
...
Route::prefix('admin')->group(function(){
	...
	//location or campus
    Route::post('/locationCreate', 'AdminController@locationCreate')->name('admin.locationcreate');
    Route::post('/locationDelete/{id}', 'AdminController@locationDelete')->name('admin.locationdelete');
    Route::get('/location/campus', 'AdminController@locationIndex')->name('admin.locationindex');
